...
CREATE TABLE `t_article` (
  ...
  `author_id` bigint DEFAULT '1' COMMENT '文章作者ID（关联t_user表的id）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

/*Data for the table `t_article` */

insert  into `t_article`(`id`,`title`,`content`,`created`,`modified`,`categories`,`tags`,`allow_comment`,`thumbnail`,`author_id`) values 
...
CREATE TABLE `t_follow` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_follower_followed` (`follower_id`,`followed_id`,`is_deleted`) COMMENT '一个用户只能关注另一个用户一次（未取消的情况下）',
...
insert  into `t_follow`(`id`,`follower_id`,`followed_id`,`created`,`is_deleted`) values 
(9,2,1,'2026-01-07',0),
(10,2,4,'2026-01-07',0),
(11,2,3,'2026-01-07',0),
(19,4,2,'2026-01-08',0),
