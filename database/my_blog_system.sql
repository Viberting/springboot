/*
 ...
 Source Schema         : my_blog_system3

 Target Server Type    : MySQL
 Target Server Version : 90400 (9.4.0)
 File Encoding         : 65001

 Date: 11/01/2026 00:14:29
*/
...
CREATE TABLE `t_article`  (
  ...
  `author_id` bigint NULL DEFAULT 1 COMMENT '文章作者ID（关联t_user表的id）',
...
CREATE TABLE `t_comment`  (
  ...
  `parent_id` int NULL DEFAULT NULL COMMENT '父评论ID，如果是顶级评论则为null',
  `root_id` int NULL DEFAULT NULL COMMENT '根评论ID，用于快速查询同一评论树的全部评论',
  `reply_to` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '被回复的用户名，用于显示\"回复@用户名\"',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `t_comment` VALUES (1, 12, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', '很不错，不过这文章排版不太好看啊', 'approved', '李四', 0, 2, NULL, 1, NULL);
INSERT INTO `t_comment` VALUES (2, 11, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', '很不错的原理分析，受用了！', 'approved', '李四', 0, 2, NULL, 2, NULL);
INSERT INTO `t_comment` VALUES (3, 10, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', '关于Docker虚拟容器的讲解挺好的额，学习中', 'approved', '李四', 0, 2, NULL, 3, NULL);
INSERT INTO `t_comment` VALUES (9, 1, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', '非常不错，赞一个！', 'approved', '李四', 0, 2, NULL, 9, NULL);
INSERT INTO `t_comment` VALUES (10, 1, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', '博主，这资料怎么弄的？有相关资源和教材推荐吗？', 'approved', '李四', 0, 2, NULL, 10, NULL);
INSERT INTO `t_comment` VALUES (11, 1, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', '很详细，感谢...', 'approved', '东方不败', 0, 3, NULL, 11, NULL);
INSERT INTO `t_comment` VALUES (12, 1, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', '很全，努力学习中...', 'approved', '东方不败', 0, 3, NULL, 12, NULL);
INSERT INTO `t_comment` VALUES (13, 1, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', '好东西，先收藏起来，哈哈', 'approved', 'tom', 0, 4, NULL, 13, NULL);
INSERT INTO `t_comment` VALUES (14, 8, '2018-12-13 00:00:00', '0:0:0:0:0:0:0:1', 'very good blog', 'approved', 'tom', 0, 4, NULL, 14, NULL);
INSERT INTO `t_comment` VALUES (35, 27, '2025-12-16 00:00:00', NULL, 'hhh', '1', 'tom', 1, 4, NULL, 35, NULL);
INSERT INTO `t_comment` VALUES (36, 27, '2025-12-17 00:00:00', NULL, '测试编辑评论管理', 'approved', 'tom', 0, 4, NULL, 36, NULL);
INSERT INTO `t_comment` VALUES (37, 27, '2025-12-18 00:00:00', NULL, '测试弹窗', 'approved', '李四', 0, 2, NULL, 37, NULL);
INSERT INTO `t_comment` VALUES (38, 12, '2026-01-06 00:00:00', NULL, '受益匪浅！', 'approved', 'tom', 0, 4, NULL, 38, NULL);
INSERT INTO `t_comment` VALUES (39, 4, '2026-01-08 00:00:00', NULL, '谢谢大家的喜欢！', 'approved', 'tom', 0, 4, NULL, 39, NULL);
INSERT INTO `t_comment` VALUES (40, 12, '2026-01-09 17:11:02', NULL, 'hhh', 'approved', 'admin', 1, 1, 1, 1, '李四');
INSERT INTO `t_comment` VALUES (41, 3, '2026-01-09 17:12:45', NULL, '111111111', 'approved', 'tom', 1, 4, NULL, 41, NULL);
INSERT INTO `t_comment` VALUES (42, 3, '2026-01-09 17:12:53', NULL, '22222', 'approved', 'tom', 1, 4, 41, 41, 'tom');
INSERT INTO `t_comment` VALUES (43, 12, '2026-01-09 17:56:18', NULL, '哪里不好看了(编辑功能测试', 'approved', 'weixiaoya', 1, 5, 1, 1, '李四');
INSERT INTO `t_comment` VALUES (44, 12, '2026-01-10 15:36:59', NULL, '魏潇雅测试评论回复功能', 'approved', 'admin', 1, 1, 38, 38, 'tom');
INSERT INTO `t_comment` VALUES (45, 12, '2026-01-10 16:01:38', NULL, '测试评论回复功能(测试编辑功能', 'approved', 'weixiaoya', 1, 5, 1, 1, '李四');
INSERT INTO `t_comment` VALUES (46, 12, '2026-01-10 16:02:59', NULL, '测试评论回复功能', 'approved', 'weixiaoya', 1, 5, 1, 1, '李四');
INSERT INTO `t_comment` VALUES (47, 12, '2026-01-10 16:12:37', NULL, '谢谢你的支持', 'approved', 'admin', 0, 1, 38, 38, 'tom');
...
CREATE TABLE `t_follow`  (
  ...
  `follower_id` int NOT NULL COMMENT '粉丝ID（关注者，即当前登录用户）',
  `followed_id` int NOT NULL COMMENT '被关注者ID（作者ID）',
  `created` date NOT NULL COMMENT '关注时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否取消关注（软删除）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_follower_followed`(`follower_id` ASC, `followed_id` ASC, `is_deleted` ASC) USING BTREE COMMENT '一个用户只能关注另一个用户一次（未取消的情况下）',
  INDEX `fk_follow_followed`(`followed_id` ASC) USING BTREE,
  CONSTRAINT `fk_follow_followed` FOREIGN KEY (`followed_id`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_follow_follower` FOREIGN KEY (`follower_id`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户关注关系表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_follow
-- ----------------------------
INSERT INTO `t_follow` VALUES (9, 2, 1, '2026-01-07', 0);
INSERT INTO `t_follow` VALUES (10, 2, 4, '2026-01-07', 0);
INSERT INTO `t_follow` VALUES (11, 2, 3, '2026-01-07', 0);
INSERT INTO `t_follow` VALUES (19, 4, 2, '2026-01-08', 0);
INSERT INTO `t_follow` VALUES (20, 4, 1, '2026-01-08', 0);
INSERT INTO `t_follow` VALUES (21, 3, 4, '2026-01-09', 0);
...
-- ----------------------------
INSERT INTO `t_statistic` VALUES (1, 1, 115, 5);
INSERT INTO `t_statistic` VALUES (2, 2, 8, 0);
...
INSERT INTO `t_statistic` VALUES (7, 7, 7, 0);
INSERT INTO `t_statistic` VALUES (8, 8, 25, 1);
INSERT INTO `t_statistic` VALUES (9, 9, 26, 0);
INSERT INTO `t_statistic` VALUES (10, 10, 29, 1);
INSERT INTO `t_statistic` VALUES (11, 11, 38, 1);
INSERT INTO `t_statistic` VALUES (12, 12, 169, 1);
INSERT INTO `t_statistic` VALUES (16, 23, 36, 0);
INSERT INTO `t_statistic` VALUES (17, 22, 6, 0);
INSERT INTO `t_statistic` VALUES (18, 24, 4, 0);
INSERT INTO `t_statistic` VALUES (19, 25, 5, 0);
INSERT INTO `t_statistic` VALUES (20, 26, 0, 0);
INSERT INTO `t_statistic` VALUES (21, 27, 29, 0);
...
CREATE TABLE `t_user`  (
  ...
  `avatar` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '头像URL',
  `intro` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '个人简介',
  `github_url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT 'GitHub链接',
  `bg_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '个人主页背景图URL',
  `gender` tinyint(1) NULL DEFAULT 2 COMMENT '性别：0=女，1=男，2=未知',
  `birthday` date NULL DEFAULT NULL COMMENT '出生日期',
  `follow_count` int NOT NULL DEFAULT 0 COMMENT '关注数（我关注了多少人）',
  `fans_count` int NOT NULL DEFAULT 0 COMMENT '粉丝数（多少人关注我）',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'admin', '$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK', '2127269781@qq.com', '2018-10-01', 1, '/api/images/184695d9-ac91-40b1-9bf5-aa65c8ecc3c6_admin_avatar.png', '如要投稿请联系管理员审核后发布', '', '/api/images/1d44d741-09d5-43bc-9f3b-e2eb545f3c0f_bg_image3.png', 2, '1990-05-22', 0, 1);
INSERT INTO `t_user` VALUES (2, '李四', '$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK', '1768653040@qq.com', '2018-11-13', 1, '/api/images/b3ce8eda-ec13-4c24-b83f-6fc0f9385215_avatar_2.png', '', '', '/api/images/d001e900-487c-477f-881e-09dd2530f30d_bg_image2.png', 0, '2006-01-11', 3, 1);
INSERT INTO `t_user` VALUES (3, '东方不败', '$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK', '13718391550@163.com', '2018-12-18', 1, '/api/images/b39f373f-2a55-453f-a773-4fad7e46c5b5_avatar_3.png', '', '', '/api/images/25fa898c-0f1e-4e78-b85f-d755f8abef6c_bg_image4.png', 2, '2007-02-28', 1, 1);
INSERT INTO `t_user` VALUES (4, 'tom', '$2a$10$PTMSJbOKqbsEs4hB2sRGUe1D6g3c9Y/mOMOaTCZm3ARYCslTnTpf2', 'asexeees@sohu.com', '2018-12-03', 1, '/api/images/2e21ff1b-3944-4089-8ed1-da29b3ae3ab1_avatar_1.png', '先悦己，再悦人！', 'https://github.com/Viberting/springboot.git', '/api/images/46d37504-993b-4e3e-a292-2b77640f88b2_bg_image1.png', 1, '2004-12-10', 2, 2);
INSERT INTO `t_user` VALUES (5, 'weixiaoya', '$2a$10$Nc00kINiXGwENUtnA97WZ.omGTqMBvtgUrmCCkzKs8TuqrKiX5GuC', 'weixiaoya@qq.com', '2026-01-10', 1, '/api/images/d2974296-322e-4f9d-9173-be6300191751_toux.jpg', 'hhhhhhhhhhhhhhhhhh', '', '/api/images/1549c7b8-5ca7-48e0-b74d-8e258cecdbd5_bj.jpg', 0, '2016-01-04', 0, 0);
INSERT INTO `t_user` VALUES (6, 'weiya2', '$2a$10$KXWRHSoKqOrTEvOAR/cW2.ELTV4yXFeVv1M9L/MxfAsbQYCQ3C7fu', 'weiya2@qq.com', '2026-01-10', 0, '/api/images/avatars.jpg', '', '', '', 2, NULL, 0, 0);
...
INSERT INTO `t_user_authority` VALUES (6, 5, 2);
INSERT INTO `t_user_authority` VALUES (8, 6, 2);
