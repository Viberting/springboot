/*
SQLyog Community
MySQL - 9.4.0 : Database - my_blog_system
*********************************************************************
*/
...
CREATE TABLE `t_user` (
  ...
  `intro` varchar(500) DEFAULT '' COMMENT '个人简介',
  `github_url` varchar(255) DEFAULT '' COMMENT 'GitHub链接',
  `bg_image` varchar(255) DEFAULT '' COMMENT '个人主页背景图URL',
...
insert  into `t_user`(`id`,`username`,`password`,`email`,`created`,`valid`,`avatar`,`intro`,`github_url`,`bg_image`,`gender`,`birthday`) values 
(1,'admin','$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK','2127269781@qq.com','2018-10-01',1,'','','','',2,NULL),
(2,'李四','$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK','1768653040@qq.com','2018-11-13',1,'','','','',2,NULL),
(3,'东方不败','$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK','13718391550@163.com','2018-12-18',1,'','','','',2,NULL),
(4,'tom','$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK','asexeees@sohu.com','2018-12-03',1,'','','','',2,NULL);
